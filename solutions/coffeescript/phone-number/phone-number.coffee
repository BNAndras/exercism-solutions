class PhoneNumber
  ...
  clean: ->
    throw 'letters not permitted' if /[a-z]/i.test @number
    throw 'punctuations not permitted' if /[@:!]/.test @number
    ...
    if cleaned.length is 11
      throw '11 digits must start with 1' unless cleaned.startsWith '1'
